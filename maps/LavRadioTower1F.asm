...
.UnknownScript_0x7ee80:
	...
	pause 10
	opentext
	writetext ExpectingMore
	buttonsound
	verbosegiveitem POKE_FLUTE
	writetext ThePokeflute
	buttonsound
	;closetext 
	thisopenedtext
...
ExpectingMore:
	...
	para "You were expect-"
	line "ing more?"
	
	para "Alright, let's see"
	line "here…"
	
	para "Ah! This should do"
	line "it then!"
	done
...
ThePokeflute:
	...
	line "never losing the"
	cont "music…"
	
	para "Whatever that"
	line "means! Gahahaha!"
	
	para "All our music is"
	line "made right here in"
	cont "the studio."
	
	para "That thing makes"
	line "me sleepy, anyway."
	done
