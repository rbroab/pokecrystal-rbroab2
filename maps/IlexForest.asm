IlexForest_MapScriptHeader:
	...
	db 2 ; coord events
	coord_event  10, 31, 2, IlexForestApprenticeTrigger
	coord_event   8, 31, 3, IlexForestBlackbeltTrigger
	...
	object_event  8, 30, SPRITE_BLACK_BELT, SPRITEMOVEDATA_STANDING_RIGHT, 0, 0, -1, -1, 0, PERSONTYPE_SCRIPT, 0, IlexForestCharcoalMasterScript, EVENT_ILEX_FOREST_CHARCOAL_MASTER
	...
	object_event 10, 30, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_SCRIPT, 0, IlexForestCharcoalApprenticeScript, EVENT_ILEX_FOREST_APPRENTICE
...
.PositionTen:
	moveobject ILEXFOREST_FARFETCHD, 9, 30
	appear ILEXFOREST_FARFETCHD
	return
...
IlexForestBlackbeltTrigger:
	showemote EMOTE_SHOCK, ILEXFOREST_BLACK_BELT, 15
	turnobject PLAYER, UP
	jump IlexForestCharcoalMasterScript
...
Text_CharcoalMasterOutro:
	text "That's the TM for"
	line "U-Turn."
	
	para "First the #mon"
	line "attacks, then it"
	
	para "switches out"
	line "right away!"
	
	para "Wish my Farfetch'd"
	line "had made a U-Turn."
