RuinsofAlphOutside_MapScriptHeader:
	...
	bg_event  1, 17, SIGNPOST_ITEM + RARE_CANDY, EVENT_RUINS_OF_ALPH_OUTSIDE_HIDDEN_RARE_CANDY
	...
	object_event  9, 26, SPRITE_YOUNGSTER, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_PURPLE, PERSONTYPE_GENERICTRAINER, 1, GenericTrainerPsychicNathan, -1
	object_event  9, 35, SPRITE_SUPER_NERD, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BROWN, PERSONTYPE_GENERICTRAINER, 1, GenericTrainerSuperNerdStan, -1
	...
	smashrock_event 6,  41
	smashrock_event 15, 41
	smashrock_event  3, 29
	smashrock_event  5, 6
	smashrock_event  4, 11
	smashrock_event  17, 21
	smashrock_event  11, 10
	smashrock_event  10, 15
