...
MasterRodIcon: 	  INCBIN "gfx/items/super_rod.2bpp.lz"
...
FridgeIcon:		  INCBIN "gfx/items/fridge.2bpp.lz"
OvenIcon:		  INCBIN "gfx/items/oven.2bpp.lz"
FanIcon:		  INCBIN "gfx/items/fan.2bpp.lz"
LawnMowerIcon:	  INCBIN "gfx/items/lawnmower.2bpp.lz"
WasherIcon:		  INCBIN "gfx/items/washer.2bpp.lz"
