...
;	callback MAPCALLBACK_TILES, AzaleaTownRainScript
	...
	bg_event 12, 16, SIGNPOST_JUMPTEXT, AzaleaGymSignText
	bg_event 29,  8, SIGNPOST_JUMPTEXT, SlowpokeWellSignText
	bg_event 19, 16, SIGNPOST_JUMPTEXT, CharcoalKilnSignText
	...
	object_event 15, 12, SPRITE_TEACHER, SPRITEMOVEDATA_WALK_UP_DOWN, 2, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_COMMAND, jumptextfaceplayer, AzaleaTownTeacherText, -1
