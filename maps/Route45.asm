Route45_MapScriptHeader:
	...
	warp_event 12, 80, HIDDEN_TREE_GROTTO, 1
	...
	bg_event 12, 79, SIGNPOST_JUMPSTD, treegrotto, HIDDENGROTTO_ROUTE_45
	bg_event 13, 79, SIGNPOST_JUMPSTD, treegrotto, HIDDENGROTTO_ROUTE_45	
