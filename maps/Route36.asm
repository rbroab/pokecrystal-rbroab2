...
WateredWeirdTreeScript:: ; export (for when you use Squirtbottle from pack)
	...
	iftrue .enabletotodile
	checkevent EVENT_GOT_TOTODILE_FROM_ELM
	iftrue .enablecyndaquil
	checkevent EVENT_GOT_CHIKORITA_FROM_ELM
	iftrue .enablecyndaquil

.enabletotodile
	clearevent EVENT_FLOWER_TOTODILE	
	end
	
.enablecyndaquil
	clearevent EVENT_FLOWER_CYNDAQUIL
	end
...
DidntCatchSudowoodo:
	...
	checkevent EVENT_GOT_CYNDAQUIL_FROM_ELM
	iftrue .enabletotodile2
	checkevent EVENT_GOT_TOTODILE_FROM_ELM
	iftrue .enablecyndaquil2
	checkevent EVENT_GOT_CHIKORITA_FROM_ELM
	iftrue .enablecyndaquil2
