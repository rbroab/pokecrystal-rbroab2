Route39_MapScriptHeader:
	...
	warp_event 14,  4, HIDDEN_TREE_GROTTO, 1
	...
	bg_event 14,  3, SIGNPOST_JUMPSTD, treegrotto, HIDDENGROTTO_ROUTE_39
	bg_event 15,  3, SIGNPOST_JUMPSTD, treegrotto, HIDDENGROTTO_ROUTE_39

	db 13 ; object events
	object_event  7, 14, SPRITE_OLIVINE_RIVAL, SPRITEMOVEDATA_WANDER, 1, 2, -1, -1, PAL_NPC_BROWN, PERSONTYPE_SCRIPT, 0, Route39CowgirlAnnieScript, -1
	object_event 13, 29, SPRITE_SAILOR, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_GENERICTRAINER, 5, GenericTrainerSailorEugene, -1
	...
	object_event 13,  7, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_PURPLE, PERSONTYPE_GENERICTRAINER, 1, GenericTrainerPsychicNorman, -1
