...
;	night_music MUSIC_ROUTE_47_HGSS,	MUSIC_ROUTE_47_HGSS_NIGHT
	night_music MUSIC_NUGGET_BRIDGE_HGSS,	MUSIC_NUGGET_BRIDGE_HGSS_NIGHT
	night_music MUSIC_CERULEAN_CITY_HGSS,	MUSIC_CERULEAN_CITY_HGSS_NIGHT
