...
.got_offset
	...
	ld hl, .black_pals
	call .timeofdaypal
	ld de, UnknBGPals palette PAL_BG_TEXT ; black
	call .copy
	pop af
	ldh [rSVBK], a
	ld a, $1
...
.loop1
	ld a, [hl]
	and $ff ^ OAM_PALETTE;PALETTE_MASK
...
.copypals
	ld de, UnknBGPals palette PAL_BG_GRAY ; red poke ball, doesn't flash
	call .copy
	ld de, UnknBGPals palette PAL_BG_RED ; flashing overworld
	call .copy
	...
	call .copy
	ld de, UnknBGPals palette PAL_BG_BROWN
	call .copy
