...
VermilionSnorlax::
    ...
    iffalse noflute
    opentext
    writetext VermilionSnorlaxTextHaveFlute
    yesorno
    iffalse dontuseflute
VermilionPlayedFluteForSnorlax::
    writetext VermilionSnorlaxTextUseFlute
    playsound SFX_POKEFLUTE
    waitsfx
    writetext VermilionSnorlaxTextWakeUp
    buttonsound
	cry SNORLAX
	closetext
...
;	writecode VAR_BATTLETYPE, BATTLETYPE_FORCEITEM
	loadwildmon SNORLAX, 60
    startbattle
;    if_equal $2, DidntBeatSnorlaxVermilion
    disappear VERMILIONCITY_BIG_SNORLAX
    reloadmapafterbattle
    opentext
    writetext VermilionSnorlaxTextSnorlaxGone
    buttonsound
    closetext
...
noflute:
    opentext
    writetext VermilionSnorlaxIsSleepingText
    buttonsound
    closetext
    end
    
;DidntBeatSnorlaxVermilion:
;    reloadmapafterbattle
;    opentext
;    writetext VermilionSnorlaxTextRanAway
;    waitbutton
;    closetext
;    end


VermilionSnorlaxIsSleepingText:
	text "Snorlax is snoring"
	line "peacefully…"
	done

VermilionSnorlaxTextHaveFlute:
	text "Snorlax is snoring"
	line "peacefully…"
...
VermilionSnorlaxTextUseFlute:
	text "<PLAYER> used the"
	line "# FLUTE!"
	done

VermilionSnorlaxTextWakeUp:
	text "…"
...
VermilionSnorlaxTextSnorlaxGone:
	text "The path is now"
	line "open!"
	done

VermilionSnorlaxTextRanAway:
