Route35_MapScriptHeader:
	...
	bg_event  3, 13, SIGNPOST_ITEM + RARE_CANDY, EVENT_ROUTE_35_HIDDEN_RARE_CANDY
	bg_event  8, 28, SIGNPOST_ITEM + NUGGET, EVENT_ROUTE_35_HIDDEN_NUGGET

	db 12 ; object events
	object_event  9, 18, SPRITE_YOUNGSTER, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_GENERICTRAINER, 2, GenericTrainerCamperIvan, -1
	...
	object_event 15, 26, SPRITE_LASS, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_GREEN, PERSONTYPE_GENERICTRAINER, 1, GenericTrainerPicnickerKim, -1
	...
	object_event  4, 9, SPRITE_FISHER, SPRITEMOVEDATA_SPINCOUNTERCLOCKWISE, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_GENERICTRAINER, 2, GenericTrainerFirebreatherWalt, -1
	...
	object_event  9, 9, SPRITE_SUPER_NERD, SPRITEMOVEDATA_SPINRANDOM_FAST, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_TRAINER, 2, TrainerJugglerIrwin, -1
	object_event  8,  6, SPRITE_OFFICER, SPRITEMOVEDATA_STANDING_DOWN, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, OfficermScript_0x19ca49, -1
	cuttree_event 21,  6, -1
	fruittree_event  4, 25, FRUITTREE_ROUTE_35, LEPPA_BERRY
	tmhmball_event 10, 12, TM_HONE_CLAWS, EVENT_ROUTE_35_TM_HONE_CLAWS
