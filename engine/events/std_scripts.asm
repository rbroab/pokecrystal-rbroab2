...
.eve
	...
	checkevent EVENT_WELCOMING_TO_POKECOM_CENTER
	iffalse .eve_center	
	farwritetext PokeComNurseEveText;NurseEveText
	buttonsound
	setevent EVENT_WELCOMED_TO_POKECOM_CENTER
	jump .ok
.eve_center
	farwritetext NurseEveText;PokeComNurseEveText
	buttonsound
	jump .ok
...
InitializeEventsScript:
	...
	setevent EVENT_AZALEA_TOWN_KURT
	setevent EVENT_SLOWPOKE_WELL_JESSIE
	setevent EVENT_SLOWPOKE_WELL_JAMES
	...
	setevent EVENT_RADIO_TOWER_JESSIE
	setevent EVENT_RADIO_TOWER_JAMES
