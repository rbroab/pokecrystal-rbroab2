...
Goldenrod5FTMMart: ; 1613b
	...
	dbw TM_SOLAR_BEAM,    20000
	dbw TM_THUNDER,       25000
	dbw TM_FIRE_BLAST,    25000
	dbw TM_BLIZZARD,      25000
	dbw TM_HYPER_BEAM,    30000
	dbw TM_GYRO_BALL,	  45000
	db -1
; 16140
...
Celadon3FTMMart: ; 161ce
	...
	dbw TM_BULK_UP,       12000
	dbw TM_CALM_MIND,     12000
	dbw TM_SWORDS_DANCE,  15000
	dbw TM_SUNNY_DAY,     25000
	dbw TM_RAIN_DANCE,    25000
	dbw TM_SANDSTORM,     25000
	dbw TM_HAIL,          25000
	db -1
; 161d5
