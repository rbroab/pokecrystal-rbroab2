Route44_MapScriptHeader:
	...
	fruittree_event  9, 5, FRUITTREE_ROUTE_44_1, ASPEAR_BERRY
	fruittree_event 19, 7, FRUITTREE_ROUTE_44_2, PNK_APRICORN
	fruittree_event 21, 7, FRUITTREE_ROUTE_44_2, GRN_APRICORN
