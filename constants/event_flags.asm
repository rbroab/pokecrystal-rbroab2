...
; Johto story events
	;const EVENT_FOUND_LOST_MON
	const EVENT_GAVECUTPOKEMON
	;const EVENT_GOT_CHIKORITA_FROM_KILN
	;const EVENT_GOT_TOTODILE_1_FROM_KILN
	const EVENT_FOUGHT_ROTOM
	const EVENT_OLD_MAN_BULBASAUR
	const EVENT_GOT_GIRL_SQUIRTLE
	const EVENT_LOST_SQUIRTLE
	const EVENT_GOT_DRAGON_EGG
	const EVENT_GOTFLOWERMON
	const EVENT_KILN_TOTODILE
	const EVENT_KILN_CHIKORITA
	const EVENT_FLOWER_TOTODILE
	const EVENT_FLOWER_CYNDAQUIL
...
; Jessie&James
	const EVENT_BEAT_JESSIE_AND_JAMES_WELL
	const EVENT_BEAT_JESSIE_AND_JAMES_48
	const EVENT_BEAT_JESSIE_AND_JAMES_TOWER
; Lorelei
...
; Johto items
	...
	const EVENT_ICE_PATH_1F_DRAGON_SCALE
	...
	const EVENT_ROUTE_35_HIDDEN_RARE_CANDY
...
; Johto people
	...
	const EVENT_RADIO_TOWER_JESSIE
	const EVENT_RADIO_TOWER_JAMES
	...
	const EVENT_SLOWPOKE_WELL_JESSIE
	const EVENT_SLOWPOKE_WELL_JAMES
...
; Kanto people
	...
	const EVENT_CERULEAN_CAPE_MISTY
...
; New to Crystal
	...
	const EVENT_ROUTE_33_SUPER_POTION
	const EVENT_ROUTE_33_HIDDEN_BOTTLE_CAP
...
; Unused placeholder events
	const EVENT_OAKS_AIDE_1
	const EVENT_OAKS_AIDE_2
	const EVENT_OAKS_AIDE_3
	const EVENT_OAKS_AIDE_4
	const EVENT_GOT_MASTER_ROD
	const EVENT_885
	const EVENT_886
	const EVENT_887
	const EVENT_888
