...
ItemEffects: ; e73c
	...
	dw NoEffect 		; OVEN
	dw NoEffect 		; FAN
	dw NoEffect 		; LAWNMOWER
	dw NoEffect 		; WASHER
	dw _PokeFlute		; POKE_FLUTE
...
;	text_jump _PlayedFluteText
;	db "@"
;	;text_end
;
;.FluteWakeUpText:
;	;text_far _FluteWakeUpText
;	text_jump _FluteWakeUpText
;	;text_end
;	db "@"
;
;.PlayedTheFlute:
;	; played the # FLUTE.@ @
;	text_jump Text_PlayedPokeFlute
;	db "@"
;	;text_asm
;	ld a, [wBattleMode]
;	and a
...
.PokefluteScript:
	...
	iftrue .vermilionsnorlaxflute
;	farjump VermilionSnorlax
	checkevent EVENT_CELADON_SNORLAX
	iffalse .route7snorlaxflute 
;	farjump CeladonSnorlax

.vermilionsnorlaxflute
	farjump VermilionSnorlax
