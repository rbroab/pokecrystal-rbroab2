...
;	object_event 50, 12, SPRITE_NEW_BARK_LYRA, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_RED, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_LYRA_ROUTE_29
	object_event 50, 12, SPRITE_NEW_BARK_LYRA, SPRITEMOVEDATA_SPINRANDOM_SLOW, 0, 0, -1, -1, PAL_NPC_BLUE, PERSONTYPE_SCRIPT, 0, ObjectEvent, EVENT_LYRA_ROUTE_29	
...
CooltrainerMScript_0x1a1031:
	checktime 1 << DAY
	iftrue_jumptextfaceplayer Text_WaitingForEvening
	checktime 1 << EVE
	iftrue_jumptextfaceplayer Text_WaitingForDay
	checktime 1 << NITE
