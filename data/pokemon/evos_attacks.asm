...
PoliwrathEvosAttacks:
	...
	db 1, BODY_SLAM
	db 1, BUBBLE_BEAM
	db 1, SWEET_KISS ; Mud Shot → event move
	db 32, BELLY_DRUM	
	db 37, DYNAMICPUNCH
...
VictreebelEvosAttacks:
	...
	db 47, POISON_JAB
	db 54, SUCKER_PUNCH	
	db 61, SWORDS_DANCE ; Leaf Blade → prior move
	db 0 ; no more level-up moves
...
CloysterEvosAttacks:
	...
	db 13, ICICLE_SPEAR ; Spikes → Icicle Spear
	db 16, PROTECT
	db 20, LEER
	db 25, ICE_SHARD
	db 28, BUBBLE_BEAM ; Clamp → egg move
...
ExeggutorEvosAttacks:
	...
	db 1, LOW_KICK ; Psyshock → HGSS tutor move
	db 1, ZEN_HEADBUTT ; Egg Bomb → tutor move
	db 11, LEECH_SEED
	db 17, SELFDESTRUCT ; Bullet Seed → RBY TM move
	db 19, STUN_SPORE
	db 21, POISONPOWDER
	...
	db 47, EXTRASENSORY
	db 50, PSYCHIC_M ; Bestow → TM move
	db 56, POWER_WHIP ; Wood Hammer → new move
	db 61, PETAL_DANCE ; Leaf Storm → new move
	db 0 ; no more level-up moves
...
HitmonleeEvosAttacks:
	...
	db 37, FORESIGHT
	db 41, PROTECT ; Wide Guard → TM move
...
PinsirEvosAttacks:
	...
	db 30, FEINT_ATTACK ; Submission → egg move
	db 35, X_SCISSOR
	db 38, SWORDS_DANCE
	db 42, THRASH
...
SnorlaxEvosAttacks:
	db 0 ; no more evolutions
	db 1, SCREECH ; Stockpile → Screech
	db 1, PROTECT ; Swallow → TM move
	db 1, TACKLE
	db 4, DEFENSE_CURL
	db 9, AMNESIA
	db 12, LICK
...
MewEvosAttacks:
	...
	db 40, BARRIER
	db 50, ANCIENTPOWER
	db 60, TRANSFORM ; Amnesia → Baton Pass
...
BellossomEvosAttacks:
	db 0 ; no more evolutions
	db 1, ABSORB
	db 1, LEECH_SEED ; Sweet Scent → event move
	db 1, POISONPOWDER
	db 1, STUN_SPORE
	db 1, SLEEP_POWDER
	db 1, CHARM ; Lucky Chant → egg move
	db 1, MEGA_DRAIN
	db 1, HEAL_BELL ; new move
	db 1, SUNNY_DAY
	db 1, STUN_SPORE
	db 29, GROWTH ; Quiver Dance → Growth
	db 34, GIGA_DRAIN
	db 39, MOONBLAST ; Petal Blizzard → Gloom move
	db 44, HYPER_VOICE ; Natural Gift → tutor move
	db 49, PETAL_DANCE ; evolution move
	db 54, HEALINGLIGHT ; Moonlight → similar move	
	db 59, SOLAR_BEAM ; Leaf Storm → TM move
	db 0 ; no more level-up moves
...
SudowoodoEvosAttacks:
	...
	db 5, LOW_KICK ; Flail → similar move
	db 8, VINE_WHIP
	db 12, LEER ; Rock Throw → new move
	db 15, ROCK_THROW ; Mimic → Rock Throw
	db 19, FEINT_ATTACK
	db 22, COUNTER ; Rock Tomb → new move
	db 26, RAZOR_LEAF ; Block → TM move
	db 29, ROCK_SLIDE
	db 33, DRAIN_PUNCH
	db 36, SUCKER_PUNCH
	db 40, SEED_BOMB
...
PolitoedEvosAttacks:
	...
	db 33, HYPER_VOICE
	db 37, BODY_SLAM
	db 40, SWEET_KISS ; Mud Shot → event move
	db 44, BELLY_DRUM
	db 48, GROWTH ; Wake-Up Slap → event move
	db 54, HYDRO_PUMP
	db 60, EARTH_POWER ; Mud Bomb → similar move
	db 0 ; no more level-up moves
...
SunkernEvosAttacks:
	...
	db 13, LEECH_SEED
	db 16, RAZOR_LEAF
	db 19, SPORE ; Worry Seed → TM move
	db 22, GIGA_DRAIN
...
;	db EVOLVE_ITEM, DUSK_STONE, HONCHKROW
	...
	db 55, SUCKER_PUNCH
	db 59, NASTY_PLOT
	db 63, PERISH_SONG ; Torment → egg move
	db 66, BRAVE_BIRD ; Quash → egg move
	db 70, DARK_PULSE	
	db 0 ; no more level-up moves
...
;	db 60, BATON_PASS ; Foul Play → XD move
...
ScizorEvosAttacks:
	...
	db 25, BUG_BITE ; Fury Cutter → similar move
	db 29, SLASH
	db 32, BUG_BUZZ ; Razor Wind → egg move
	db 35, GLARE
	db 38, DEFENSE_CURL ; Iron Defense → similar move
	db 41, X_SCISSOR
...
Porygon2EvosAttacks:
	...
	db 34, BARRIER ; Recycle → event move
	db 40, THUNDERBOLT ; Discharge → TM move
	db 45, PAIN_SPLIT ; Lock-On → new move
	db 50, TRI_ATTACK
	db 56, MIRROR_COAT ; Magic Coat → new move
	db 62, ZAP_CANNON
	db 67, HYPER_BEAM
...
LugiaEvosAttacks:
	...
	db 29, RAIN_DANCE
	db 37, HYDRO_PUMP
	db 45, AEROBLAST ; Aeroblast → TM move
	db 51, DRAGON_PULSE ; Punishment → Aeroblast
...
HoOhEvosAttacks:
	...
	db 29, SUNNY_DAY
	db 37, FIRE_BLAST
	db 45, SACRED_FIRE ; Sacred Fire → Solar Beam
	db 51, SOLAR_BEAM ; Punishment → Sacred Fire
...
CelebiEvosAttacks:
	...
	db 1, METRONOME
	db 1, HEAL_BELL
	db 1, CONFUSION ; Heal Bell → new move
	db 8, SAFEGUARD
	db 16, ENERGY_BALL ; Magical Leaf → TM move
	db 24, ANCIENTPOWER
	db 32, DRAIN_KISS
	db 40, BATON_PASS
	db 48, PETAL_DANCE
	db 54, MOONBLAST ; Natural Gift → new move
	db 60, LIGHT_SCREEN ; Heal Block → TM move
	db 68, FUTURE_SIGHT
	db 76, PSYCHIC_M ; Healing Wish → Heal Bell
