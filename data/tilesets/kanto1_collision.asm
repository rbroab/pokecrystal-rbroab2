	...
	tilecoll WALL, TOP_WALL, WALL, FLOOR ; 94
	tilecoll TOP_WALL, TOP_WALL, FLOOR, FLOOR ; 95
	tilecoll TOP_WALL, WALL, FLOOR, WALL ; 96
	tilecoll BOTTOM_WALL, FLOOR, CAVE, WALL ; 97
