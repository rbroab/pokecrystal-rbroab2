...
; entries correspond to SPECIALCALL_* constants
	...
	specialcall SpecialCallOnlyWhenOutside, PHONE_KRIS, LyraPhoneScript2      ; SPECIALCALL_YELLOWFOREST
	specialcall SpecialCallOnlyWhenOutside, PHONE_KRIS, LyraPhoneScript2      ; SPECIALCALL_FIRSTBADGE
	specialcall SpecialCallOnlyWhenOutside, PHONE_BILL, BillPhoneScript2      ; SPECIALCALL_SECONDBADGE
	specialcall SpecialCallOnlyWhenOutside, PHONE_KRIS, LyraPhoneScript2      ; SPECIALCALL_LYRASEGG