...
.trainers
	...
	dbw LYRA1,            MUSIC_RIVAL_BATTLE_XY;MUSIC_LYRA_ENCOUNTER_HGSS;MUSIC_RIVAL_BATTLE_XY
	dbw LYRA2,            MUSIC_RIVAL_BATTLE_XY;MUSIC_LYRA_ENCOUNTER_HGSS;MUSIC_WALLY_BATTLE_ORAS
