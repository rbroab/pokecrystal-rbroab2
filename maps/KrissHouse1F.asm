...
;	warp_event  6,  7, VERMILION_CITY, 5
;	warp_event  7,  7, VERMILION_CITY, 5
;	warp_event  6, 7, LAV_RADIO_TOWER_1F, 1
;	warp_event  6, 7, LAV_RADIO_TOWER_1F, 1
	...
	object_event  7,  3, SPRITE_MOM, SPRITEMOVEDATA_STANDING_UP, 0, 0, -1, (1 << EVE), 0, PERSONTYPE_SCRIPT, 0, MomScript, EVENT_KRISS_HOUSE_MOM_2
	object_event  7,  3, SPRITE_MOM, SPRITEMOVEDATA_STANDING_LEFT, 0, 0, -1, (1 << NITE), 0, PERSONTYPE_SCRIPT, 0, MomScript, EVENT_KRISS_HOUSE_MOM_2
