...
Moves:: ; 41afb
	...
	move DRAGON_CLAW,  EFFECT_NORMAL_HIT,         90, DRAGON,    100, 15,   0, PHYSICAL
	...
	move X_SCISSOR,    EFFECT_NORMAL_HIT,         85, BUG,       100, 15,   0, PHYSICAL
	move NIGHT_SLASH,  EFFECT_NORMAL_HIT,         75, DARK,      100, 15,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move CUT,          EFFECT_NORMAL_HIT,         70, GRASS,     100, 20,   0, PHYSICAL
endc
...
endc
	...
	move FLARE_BLITZ,  EFFECT_FLARE_BLITZ,       120, FIRE,      100, 15,  15, PHYSICAL
	move STONE_EDGE,   EFFECT_NORMAL_HIT,        100, ROCK,       85,  5,   0, PHYSICAL
	move FOCUS_BLAST,  EFFECT_SP_DEF_DOWN_HIT,   120, FIGHTING,   80,  5,  10, SPECIAL
	move TOXIC_SPIKES, EFFECT_TOXIC_SPIKES,        0, POISON,    100, 20,   0, STATUS
	move HEADBUTT,     EFFECT_FLINCH_HIT,         75, NORMAL,    100, 15,  30, PHYSICAL
...
endc
	...
	move LEER,         EFFECT_DEFENSE_DOWN,        0, NORMAL,     90, 30,   0, STATUS
	move BITE,         EFFECT_FLINCH_HIT,         60, DARK,      100, 25,  30, PHYSICAL
	move GROWL,        EFFECT_ATTACK_DOWN,         0, NORMAL,     90, 40,   0, STATUS
	move ROAR,         EFFECT_ROAR,                0, NORMAL,     90, 20,   0, STATUS
if DEF(FAITHFUL)
	move SING,         EFFECT_SLEEP,               0, NORMAL,     55, 15,   0, STATUS
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,     55, 20,   0, STATUS
else
	move SING,         EFFECT_SLEEP,               0, NORMAL,     90, 15,   0, STATUS
	move SUPERSONIC,   EFFECT_CONFUSE,             0, NORMAL,     90, 20,   0, STATUS
endc
	move SONIC_BOOM,   EFFECT_STATIC_DAMAGE,      20, NORMAL,     90, 20,   0, SPECIAL
	move DISABLE,      EFFECT_DISABLE,             0, NORMAL,     90, 20,   0, STATUS
	move ACID,         EFFECT_SP_DEF_DOWN_HIT,    40, POISON,    100, 30,  10, SPECIAL
	move EMBER,        EFFECT_BURN_HIT,           40, FIRE,      100, 25,  15, SPECIAL
	...
	move HYDRO_PUMP,   EFFECT_NORMAL_HIT,        120, WATER,      85,  5,   0, SPECIAL
	move SURF,         EFFECT_NORMAL_HIT,        100, WATER,     100, 15,   0, SPECIAL
	move ICE_BEAM,     EFFECT_FREEZE_HIT,         90, ICE,       100, 10,  20, SPECIAL
	move BLIZZARD,     EFFECT_FREEZE_HIT,        120, ICE,        80,  5,  25, SPECIAL
	move PSYBEAM,      EFFECT_CONFUSE_HIT,        65, PSYCHIC,   100, 20,  15, SPECIAL
	move BUBBLE_BEAM,  EFFECT_SPEED_DOWN_HIT,     65, WATER,     100, 20,  15, SPECIAL
	move AURORA_BEAM,  EFFECT_ATTACK_DOWN_HIT,    65, ICE,       100, 20,  15, SPECIAL
	...
	move COUNTER,      EFFECT_COUNTER,             1, FIGHTING,   95, 20,   0, PHYSICAL
...
if DEF(FAITHFUL)
	...
	move STRENGTH,     EFFECT_FLINCH_HIT,         80, ROCK,      100, 15,  20, PHYSICAL
endc
	...
	move SOLAR_BEAM,   EFFECT_SOLAR_BEAM,        130, GRASS,     100, 10,   0, SPECIAL
	move POISONPOWDER, EFFECT_POISON,              0, POISON,     85, 35,   0, STATUS
	move STUN_SPORE,   EFFECT_PARALYZE,            0, GRASS,      85, 30,   0, STATUS
	move SLEEP_POWDER, EFFECT_SLEEP,               0, GRASS,      85, 15,   0, STATUS
...
endc
	move THUNDERSHOCK, EFFECT_PARALYZE_HIT,       40, ELECTRIC,  100, 30,  15, SPECIAL
	...
	move THUNDER,      EFFECT_THUNDER,           120, ELECTRIC,   80, 10,  30, SPECIAL
...
endc
	...
	move PSYCHIC_M,    EFFECT_SP_DEF_DOWN_HIT,    90, PSYCHIC,   100, 15,  15, SPECIAL
	move HYPNOSIS,     EFFECT_SLEEP,               0, PSYCHIC,    85, 20,   0, STATUS
	...
	move DRAGON_PULSE, EFFECT_NORMAL_HIT,         90, DRAGON,    100, 10,   0, SPECIAL
	...
	move CONFUSE_RAY,  EFFECT_CONFUSE,             0, GHOST,      90, 10,   0, STATUS
	move AQUA_TAIL,    EFFECT_NORMAL_HIT,        100, WATER,      90, 10,   0, PHYSICAL
	...
	move FLASH_CANNON, EFFECT_SP_DEF_DOWN_HIT,    80, STEEL,     100, 10,  15, SPECIAL
if DEF(FAITHFUL)
...
endc
	...
	move SELFDESTRUCT, EFFECT_EXPLOSION,         160, NORMAL,    100,  5,   0, PHYSICAL
	move SKILL_SWAP,   EFFECT_SKILL_SWAP,          0, PSYCHIC,   100, 10,   0, STATUS
	move LICK,         EFFECT_PARALYZE_HIT,       35, GHOST,     100, 30,  30, PHYSICAL
	move GUNK_SHOT,    EFFECT_POISON_HIT,        120, POISON,     85,  5,  30, PHYSICAL
	move VENOSHOCK,    EFFECT_CONDITIONAL_BOOST,  65, POISON,    100, 10,   0, SPECIAL
	move EARTH_POWER,  EFFECT_SP_DEF_DOWN_HIT,    90, GROUND,    100, 10,  15, SPECIAL
	move FIRE_BLAST,   EFFECT_BURN_HIT,          120, FIRE,       85,  5,  25, SPECIAL
	move WATERFALL,    EFFECT_FLINCH_HIT,         90, WATER,      90, 15,  25, PHYSICAL
	...
	move HI_JUMP_KICK, EFFECT_JUMP_KICK,         130, FIGHTING,   80, 10,   0, PHYSICAL
	move GLARE,        EFFECT_PARALYZE,            0, NORMAL,     90, 15,   0, STATUS
	...
	move BULLET_PUNCH, EFFECT_PRIORITY_HIT,       45, STEEL,     100, 30,   0, PHYSICAL
	move LEECH_LIFE,   EFFECT_LEECH_HIT,          80, BUG,       100, 10,   0, PHYSICAL
	move DRAIN_KISS,   EFFECT_LEECH_HIT,          65, FAIRY,     100, 10,   0, SPECIAL
	...
	move FLASH,        EFFECT_ACCURACY_DOWN_HIT,  20, ELECTRIC,   80, 10, 100, SPECIAL
	move EXTRASENSORY, EFFECT_FLINCH_HIT,         80, PSYCHIC,   100, 20,  15, SPECIAL
...
endc
	...
	move REST,         EFFECT_HEAL,                0, PSYCHIC,    95, 10,   0, STATUS
	move ROCK_SLIDE,   EFFECT_FLINCH_HIT,         75, ROCK,       90, 10,  30, PHYSICAL
	move HYPER_FANG,   EFFECT_FLINCH_HIT,         80, NORMAL,     90, 15,  15, PHYSICAL
	...
	move FLAME_WHEEL,  EFFECT_FLAME_WHEEL,        60, FIRE,      100, 25,  15, PHYSICAL
	move HYPER_VOICE,  EFFECT_NORMAL_HIT,         90, NORMAL,    100, 10,   0, SPECIAL
	move CURSE,        EFFECT_CURSE,               0, GHOST,     100, 10,   0, STATUS
	move GYRO_BALL,    EFFECT_SPEED_DOWN_HIT,     80, STEEL,     100, 10,  20, PHYSICAL
	move ENERGY_BALL,  EFFECT_SP_DEF_DOWN_HIT,    90, GRASS,     100, 10,  10, SPECIAL
	move AEROBLAST,    EFFECT_NORMAL_HIT,        120, FLYING,     90, 10,   0, SPECIAL
	move SEED_BOMB,    EFFECT_NORMAL_HIT,         90, GRASS,      90, 15,   0, PHYSICAL
	...
	move SWEET_KISS,   EFFECT_CONFUSE,             0, FAIRY,      85, 10,   0, STATUS
	move BELLY_DRUM,   EFFECT_BELLY_DRUM,          0, NORMAL,    100, 10,   0, STATUS
	move SLUDGE_BOMB,  EFFECT_POISON_HIT,         90, POISON,    100, 10,  30, SPECIAL
	move MUD_SLAP,     EFFECT_ACCURACY_DOWN_HIT,  20, GROUND,    90, 10, 100, SPECIAL
if DEF(FAITHFUL)
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  65, WATER,      85, 10,  50, SPECIAL
else
	move OCTAZOOKA,    EFFECT_ACCURACY_DOWN_HIT,  80, WATER,      95, 10,  30, SPECIAL
endc
	move SPIKES,       EFFECT_SPIKES,              0, GROUND,    100, 20,   0, STATUS
	move ZAP_CANNON,   EFFECT_PARALYZE_HIT,      120, ELECTRIC,   70,  5, 100, SPECIAL
	...
	move ATTRACT,      EFFECT_ATTRACT,             0, NORMAL,     90, 15,   0, STATUS
...
endc
	move SACRED_FIRE,  EFFECT_SACRED_FIRE,       100, FIRE,       90, 10,  50, PHYSICAL
	...
	move DRAGONBREATH, EFFECT_PARALYZE_HIT,       75, DRAGON,    100, 20,  30, SPECIAL
	...
	move SHADOW_CLAW,  EFFECT_NORMAL_HIT,         75, GHOST,     100, 15,   0, PHYSICAL
	move IRON_TAIL,    EFFECT_DEFENSE_DOWN_HIT,  100, STEEL,      85, 15,  30, PHYSICAL
	move METAL_CLAW,   EFFECT_ATTACK_UP_HIT,      50, STEEL,      95, 35,  15, PHYSICAL
	move AURA_SPHERE,  EFFECT_ALWAYS_HIT,         80, FIGHTING,  100, 20,   0, SPECIAL
	move HEALINGLIGHT, EFFECT_HEALING_LIGHT,       0, FAIRY,     100,  5,   0, STATUS
	move HURRICANE,    EFFECT_CONFUSE_HIT,       100, FLYING,     85, 10,  30, SPECIAL
...
endc
	...
	move RAIN_DANCE,   EFFECT_RAIN_DANCE,          0, WATER,      90, 10,   0, STATUS
	move SUNNY_DAY,    EFFECT_SUNNY_DAY,           0, FIRE,       90, 10,   0, STATUS
	move CRUNCH,       EFFECT_DEFENSE_DOWN_HIT,   85, DARK,      100, 15,  20, PHYSICAL
	...
	move ANCIENTPOWER, EFFECT_ALL_UP_HIT,         60, ROCK,      100,  5,  20, SPECIAL
...
if DEF(FAITHFUL)
	...
	move ROCK_SMASH,   EFFECT_DEFENSE_DOWN_HIT,   75, FIGHTING,  100, 15,  40, PHYSICAL
endc
if DEF(FAITHFUL)
